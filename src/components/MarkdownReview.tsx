			...
			blocks.push(
				createElement(
					"h4",
					{
						key: blocks.length,
						className:
							"text-sm font-semibold text-foreground mt-4 mb-1.5 scroll-mt-4",
					},
			...
			blocks.push(
				createElement(
					"h3",
					{
						key: blocks.length,
						className:
							"text-base font-semibold text-foreground mt-5 mb-2 scroll-mt-4 first:mt-0",
					},
			...
			blocks.push(
				createElement(
					"h2",
					{
						key: blocks.length,
						className:
							"text-lg font-semibold text-foreground mt-4 mb-2 scroll-mt-4",
					},
			...
			blocks.push(
				createElement(
					"ul",
					{
						key: blocks.length,
						className:
							"list-disc list-inside space-y-1 my-2 text-[13px] text-muted-foreground",
					},
					items.map((item, j) =>
						createElement(
							"li",
