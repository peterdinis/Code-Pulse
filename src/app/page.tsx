...
function StatItem({ num, label }: { num: string; label: string }) {
  ...
  // parse numeric prefix, keep suffix
...
const Homepage: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>CodePulse — AI Code Review</title>
      ...
      <div className="scanline overflow-x-hidden font-mono antialiased bg-[#0a0c0f] text-[#c9d1d9] leading-normal selection:bg-[#00e5a0]/30 selection:text-white">
        ...
        >
          <motion.a
            href="#"
            className="font-syne font-extrabold text-[1.1rem] text-white flex items-center gap-2 tracking-tight"
            initial={{ opacity: 0, x: -16 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.5, ease: "easeOut" }}
          >
            <span className="w-2 h-2 rounded-full bg-[#00e5a0] shadow-[0_0_8px_#00e5a0] animate-pulse-dot" />
            CodePulse
          </motion.a>
          ...
          >
            {["Features", "Pricing", "Docs"].map((item, i) => (
              <motion.li key={item} variants={fadeIn as unknown as Variants} custom={i * 0.08}>
                <a
                  href={item === "Features" ? "#features" : item === "Pricing" ? "#pricing" : "/docs"}
                  className="text-[13px] text-[#6e7681] hover:text-[#00e5a0] transition-colors tracking-wide"
                >
                  {item}
                </a>
              </motion.li>
          ...
          >
            <div className="bg-[#0f1218] border border-[#1e2733] rounded-xl overflow-hidden shadow-[0_0_0_1px_#1e2733,0_32px_64px_rgba(0,0,0,0.5),0_0_80px_rgba(0,229,160,0.04)]">
              <div className="flex items-center gap-2 px-4 py-3 bg-[#151b24] border-b border-[#1e2733]">
                ...
                <div className="mx-auto text-[11px] text-[#6e7681] tracking-wide">
        ...
        >
          <motion.p
            className="text-[11px] text-[#00e5a0] uppercase tracking-[0.2em] mb-4 relative z-10"
            initial={{ opacity: 0 }}
          ...
          <motion.p
            className="text-[14px] md:text-base text-[#6e7681] leading-relaxed max-w-[500px] mx-auto mb-10 relative z-10"
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            viewport={{ once: true }}
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-[240px] bg-[#0f1218] border-[#1e2733] text-[#c9d1d9] rounded-xl shadow-2xl p-1.5 focus:outline-none">
        <DropdownMenuGroup>
          ...
          <DropdownMenuItem className="focus:bg-[#151b24] focus:text-white rounded-lg transition-colors cursor-pointer outline-none p-0">
            <a href="/api/auth/gitlab" className="flex items-center gap-3 px-3 py-2.5 group w-full">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-[#6e7681]">gitlab.com</span>
              </div>
            </a>
          </DropdownMenuItem>

          <DropdownMenuItem className="focus:bg-[#151b24] focus:text-white rounded-lg transition-colors cursor-pointer outline-none p-0">
            <a href="/api/auth/bitbucket" className="flex items-center gap-3 px-3 py-2.5 group w-full">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-[#6e7681]">bitbucket.org</span>
              </div>
            </a>
          </DropdownMenuItem>
        </DropdownMenuGroup>
        ...
        <div className="px-3 py-2 text-[10px] text-center text-[#6e7681]">
          No account? <a href="/signup" className="text-[#00e5a0] hover:underline">Sign up free</a>
        </div>
      </DropdownMenuContent>
    </DropdownMenu>
  );
